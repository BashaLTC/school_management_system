...
urlpatterns = [
    # Student endpoints
    path(r'^main_app/create_student$', CreateStudent.as_view()),
    path(r'^main_app/search_student$', SearchStudent.as_view()),
    path(r'^main_app/delete_student$', DeleteStudent.as_view()),
